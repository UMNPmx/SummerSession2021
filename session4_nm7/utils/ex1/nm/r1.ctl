...
C       ; This refers to comment column; its nice to have
...
$DATA
        dat1.csv        ; dir
        ignore=@        ; This refers to ignoring all non-numerical values 
...
$TAB  C ID DV AMT MDV IPRED PRED CWRES 
        ONEHEADER NOPRINT NOAPPEND 
        FILE=r1.tab 
