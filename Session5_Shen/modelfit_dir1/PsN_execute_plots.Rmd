...
#Created 2021-08-13 at 15:45

xpose.runno <- '001'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/Users/shencheng/Documents/GitHub/SummerSession2021/Session5_Shen/modelfit_dir1/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/local/Cellar/perl/5.34.0/lib/perl5/site_perl/5.34.0/PsN_5_2_6/R-scripts' # This is not used
raw.results.file <- 'raw_results_run1.csv'
theta.labels <- c('KTR','CL','VC')
theta.fixed <- c(FALSE,FALSE,FALSE)
omega.labels <- c('IIV KTR','IIV CL','OMEGA(3,2)','IIV VC')
omega.fixed <- c(FALSE,FALSE,FALSE,FALSE)
sigma.labels <- c('Prop ERR')
sigma.fixed <- c(FALSE)
n.eta <- 3
n.eps <- 1
